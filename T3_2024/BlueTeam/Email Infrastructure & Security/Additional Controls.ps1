...
# Enable
Set-MalwareFilterPolicy -Identity 'Default (Default)' -EnableInternalSenderAdminNotifications $True -InternalSenderAdminAddress blueteam@redbackops.com
...
# New-SafeAttachmentPolicy -Name "Redback_SafeAttachmentPolicy_All" -Enable $true

<# New-SafeAttachmentPolicy -Name Redback_SafeAttachmentPolicy_All `
    -Enable $true `
    -Action Block `
    -Redirect $true `
    -RedirectAddress blueteam@redbackops.com `
